...
(function(factory) {
	if (typeof define === 'function' && define.amd) {
		define([ 'jquery', 'public/plugins/bower_components/moment/moment' ], factory);
	}
	else if (typeof exports === 'object') { // Node/CommonJS
		module.exports = factory(require('jquery'), require('public/plugins/bower_components/moment/moment'));
	}
	else {
