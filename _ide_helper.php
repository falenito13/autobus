 ...
 * Generated for Laravel 5.8.35 on 2019-10-22 08:22:36.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Lang {
        ...
        {
                        /** @var \HighSolutions\TranslationManager\Translator $instance */
         ...
         * @static
         */
        public static function transEditable($key, $replace = array(), $locale = null, $fallback = true)
        {
                        /** @var \HighSolutions\TranslationManager\Translator $instance */
                        return $instance->transEditable($key, $replace, $locale, $fallback);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
                        \HighSolutions\TranslationManager\Translator::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
                        \HighSolutions\TranslationManager\Translator::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
                        return \HighSolutions\TranslationManager\Translator::hasMacro($name);
        }
    ...
    class Route {
        ...
        {
                        return Router::localizedGroup($callback, $attributes);
        }
        ...
        {
                        return Router::transGet($trans, $action);
        }
        ...
        {
                        return Router::transPost($trans, $action);
        }
        ...
        {
                        return Router::transPut($trans, $action);
        }
        ...
        {
                        return Router::transPatch($trans, $action);
        }
        ...
        {
                        return Router::transDelete($trans, $action);
        }
        ...
        {
                        return Router::transOptions($trans, $action);
        }
        ...
        {
                        return Router::transAny($trans, $action);
        }
...
namespace Mcamara\LaravelLocalization\Facades {
    ...
    use Mcamara\LaravelLocalization\Repository;
...
namespace Arcanedev\Localization\Facades {
    ...
    class Localization {
        ...
        public static function getDefaultLocale()
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getDefaultLocale();
        }
        ...
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->setSupportedLocales($supportedLocales);
        }
        ...
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getSupportedLocalesKeys();
        }
         ...
         * @static
         */
        public static function getCurrentLocaleLangId()
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getCurrentLocaleLangId();
        }
        ...
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getCurrentLocaleEntity();
        }
         ...
         * @static
         */
        public static function getLocalizedURL($locale = null, $url = null, $attributes = array(), $showHiddenLocale = false)
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getLocalizedURL($locale, $url, $attributes, $showHiddenLocale);
        }
         ...
         * @static
         */
        public static function getUrlFromRouteName($locale, $transKey, $attributes = array(), $showHiddenLocale = false)
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->getUrlFromRouteName($locale, $transKey, $attributes, $showHiddenLocale);
        }
        ...
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->setRouteNameFromRequest($request);
        }
        ...
        {
                        /** @var \Arcanedev\Localization\Localization $instance */
                        return $instance->isDefaultLocaleHiddenInUrl();
        }
