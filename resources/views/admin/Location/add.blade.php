        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="row">
                            <form data-toggle="validator" action="{{ route('admin.locations.addpost') }}" data-success-url="{{ route('admin.locations') }}" method="POST" onsubmit="return admin.savePost(this)">
                                @CSRF
                                <div class=".col-md-6">
                                    ...
                                    <div class="form-group">
                                        <p class="hidden">სურათის ზომა - 1200/800</p>
