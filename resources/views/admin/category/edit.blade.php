        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="row">
                            <form data-toggle="validator" action="{{ route('admin.category.editpost') }}"
                                  data-success-url="{{ route('admin.category') }}" method="POST"
...
@section('footer')
    ...
    <script type="text/javascript" data-accepted_files=".jpg,.jpeg,.png" data-PostTable="category" data-max_files="2" src="/admin_assets/js/file.js"></script>
    <script>
