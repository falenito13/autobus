        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="row">
                            <form data-toggle="validator" action="{{ route('admin.additionalService.editpost') }}"
                                  data-success-url="{{ route('admin.additionalService') }}" method="POST"
...
@section('footer')
    ...
    <script type="text/javascript" data-accepted_files=".jpg,.jpeg,.png" data-PostTable="service" data-max_files="1s" src="/admin_assets/js/file.js"></script>
    <script>
