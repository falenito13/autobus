        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="row">
                            <form data-toggle="validator" action="{{ route('admin.blog.addpost') }}" data-success-url="{{ route('admin.blog') }}" method="POST" onsubmit="return admin.savePost(this)">
                                @CSRF
                                <div class=".col-md-6">
...
@section('footer')
    ...
    <script type="text/javascript" data-accepted_files=".jpeg,.jpg,.png" data-PostTable="blog" data-max_files="1" src="/admin_assets/js/file.js"></script>
    <script>
